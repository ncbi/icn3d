    ...
    if(this.bGlycansCartoon) {
        ...
        for(var i in atomHash) {
            ...
            if(atom.het && this.glycanHash.hasOwnProperty(atom.resn) != -1) {
                ...
                glycan2resids[atom.resn].push(atom.structure + '_' + atom.chain + '_' + atom.resi);
            }
        }
        ...
        for(var i = 0, il = glycanNames.length; i < il; ++i) {
            ...
            resiArray = glycan2resids[glycanName];
            for(var j = 0, jl = resiArray.length; j < jl; ++j) {
                ...
                if(shape == 'cube') {
                    ...
                    var arrowZ = this.createArrow( dirZ, new THREE.Vector3(0, 0, -1*radius).add(center), 0, color, 2*radius, 2*radius);
                    this.mdl.add( arrowZ );
                    ...
                    this.createCylinder(p0, p1, radius, color, false, color, false);
                }
            }
        }
    }
