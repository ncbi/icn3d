...
iCn3DUI.prototype.showAnnotations = function() { var me = this; //"use strict";
...
iCn3DUI.prototype.showAnnoSeqData = function(nucleotide_chainid, chemical_chainid, chemical_set) { var me = this; //"use strict";
...
iCn3DUI.prototype.enableHlSeq = function() { var me = this; //"use strict";
    if(! me.isMobile()) {
...
iCn3DUI.prototype.updateClinvar = function() { var me = this; //"use strict";
...
iCn3DUI.prototype.updateSnp = function() { var me = this; //"use strict";
...
iCn3DUI.prototype.updateDomain = function() { var me = this; //"use strict";
...
iCn3DUI.prototype.updateInteraction = function() { var me = this; //"use strict";
...
iCn3DUI.prototype.getAnDiv = function(chnid, anno) { var me = this; //"use strict";
...
iCn3DUI.prototype.addButton = function(chnid, classvalue, name, desc, width, buttonStyle) { var me = this; //"use strict";
...
iCn3DUI.prototype.conservativeReplacement = function(resA, resB) { var me = this; //"use strict";
...
iCn3DUI.prototype.getColorhexFromBlosum62 = function(resA, resB) { var me = this; //"use strict";
    var iA = (me.b62ResArray.indexOf(resA) !== -1) ? me.b62ResArray.indexOf(resA) : me.b62ResArray.length - 1; // or the last one "*"
    var iB = (me.b62ResArray.indexOf(resB) !== -1) ? me.b62ResArray.indexOf(resB) : me.b62ResArray.length - 1; // or the last one "*"
...
iCn3DUI.prototype.getProteinName= function(chnid) { var me = this; //"use strict";
    var fullProteinName = '';
...
iCn3DUI.prototype.getSequenceData = function(chnid, chnidBase, type, index) { var me = this; //"use strict";
    var fullProteinName = me.getProteinName(chnid);
    var proteinName = fullProteinName;
    if(proteinName.length > 40) proteinName = proteinName.substr(0, 40) + "...";
...
iCn3DUI.prototype.getCombinedSequenceData = function(name, residArray, index) { var me = this; //"use strict";
...
iCn3DUI.prototype.insertGapOverview = function(chnid, seqIndex) {  var me = this; //"use strict";
  var html2 = '';
...
iCn3DUI.prototype.showSeq = function(chnid, chnidBase, type, queryTitle, compTitle, queryText, compText) {  var me = this; //"use strict";
    var bNonMmdb = false;
...
iCn3DUI.prototype.navClinVar = function(chnid) { var me = this; //"use strict";
    me.currClin[chnid] = - 1;
...
iCn3DUI.prototype.showClinVarLabelOn3D = function(chnid) { var me = this; //"use strict";
...
iCn3DUI.prototype.showSnp = function(chnid, chnidBase) { var me = this; //"use strict";
    me.showSnpClinvar(chnid, chnidBase, true);
};

iCn3DUI.prototype.showClinvar = function(chnid, chnidBase) { var me = this; //"use strict";
    me.showSnpClinvar(chnid, chnidBase, false);
};

iCn3DUI.prototype.showSnpClinvar = function(chnid, chnidBase, bSnpOnly) { var me = this; //"use strict";
   // get gi from acc
...
iCn3DUI.prototype.showSnpPart2 = function(chnid, chnidBase, gi) { var me = this; //"use strict";
    if(gi !== undefined) {
...
iCn3DUI.prototype.processNoClinvar = function(chnid) { var me = this; //"use strict";
...
iCn3DUI.prototype.processNoSnp = function(chnid) { var me = this; //"use strict";
...
iCn3DUI.prototype.showCddSiteAll = function() { var me = this; //"use strict";
    var chnidBaseArray = $.map(me.protein_chainid, function(v) { return v; });
...
iCn3DUI.prototype.showDomainPerStructure = function(index) { var me = this; //"use strict";
...
iCn3DUI.prototype.showDomainAll = function() { var me = this; //"use strict";
    //var chnid = Object.keys(me.protein_chainid)[0];
    //var pdbid = chnid.substr(0, chnid.indexOf('_'));
    var pdbArray = Object.keys(me.icn3d.structures);
...
iCn3DUI.prototype.showDomainWithData = function(chnid, data) { var me = this; //"use strict";
...
iCn3DUI.prototype.showTransmem_base = function(chnid, chnidBase) { var me = this; //"use strict";
    var residHash = {};
...
iCn3DUI.prototype.setAnnoTabAll = function () {  var me = this; //"use strict";
...
iCn3DUI.prototype.hideAnnoTabAll = function () {  var me = this; //"use strict";
...
iCn3DUI.prototype.hideAnnoTabCustom = function () {  var me = this; //"use strict";
    $("[id^=" + me.pre + "custom]").hide();
    if($("#" + me.pre + "anno_custom").length) $("#" + me.pre + "anno_custom")[0].checked = false;
};

iCn3DUI.prototype.setAnnoTabClinvar = function () {  var me = this; //"use strict";
    $("[id^=" + me.pre + "clinvar]").show();
    if($("#" + me.pre + "anno_clinvar").length) $("#" + me.pre + "anno_clinvar")[0].checked = true;
...
iCn3DUI.prototype.hideAnnoTabClinvar = function () {  var me = this; //"use strict";
    $("[id^=" + me.pre + "clinvar]").hide();
    if($("#" + me.pre + "anno_clinvar").length) $("#" + me.pre + "anno_clinvar")[0].checked = false;
};

iCn3DUI.prototype.setAnnoTabSnp = function () {  var me = this; //"use strict";
    $("[id^=" + me.pre + "snp]").show();
    if($("#" + me.pre + "anno_snp").length) $("#" + me.pre + "anno_snp")[0].checked = true;
...
iCn3DUI.prototype.hideAnnoTabSnp = function () {  var me = this; //"use strict";
    $("[id^=" + me.pre + "snp]").hide();
    if($("#" + me.pre + "anno_snp").length) $("#" + me.pre + "anno_snp")[0].checked = false;
};

iCn3DUI.prototype.setAnnoTabCdd = function () {  var me = this; //"use strict";
    $("[id^=" + me.pre + "cdd]").show();
    if($("#" + me.pre + "anno_cdd").length) $("#" + me.pre + "anno_cdd")[0].checked = true;
};

iCn3DUI.prototype.hideAnnoTabCdd = function () {  var me = this; //"use strict";
    $("[id^=" + me.pre + "cdd]").hide();
    if($("#" + me.pre + "anno_cdd").length) $("#" + me.pre + "anno_cdd")[0].checked = false;
};

iCn3DUI.prototype.setAnnoTab3ddomain = function () {  var me = this; //"use strict";
    $("[id^=" + me.pre + "domain]").show();
    if($("#" + me.pre + "anno_3dd").length) $("#" + me.pre + "anno_3dd")[0].checked = true;
...
iCn3DUI.prototype.hideAnnoTab3ddomain = function () {  var me = this; //"use strict";
    $("[id^=" + me.pre + "domain]").hide();
    if($("#" + me.pre + "anno_3dd").length) $("#" + me.pre + "anno_3dd")[0].checked = false;
};

iCn3DUI.prototype.setAnnoTabSite = function () {  var me = this; //"use strict";
    $("[id^=" + me.pre + "site]").show();
    if($("#" + me.pre + "anno_binding").length) $("#" + me.pre + "anno_binding")[0].checked = true;
};

iCn3DUI.prototype.hideAnnoTabSite = function () {  var me = this; //"use strict";
    $("[id^=" + me.pre + "site]").hide();
    if($("#" + me.pre + "anno_binding").length) $("#" + me.pre + "anno_binding")[0].checked = false;
};

iCn3DUI.prototype.setAnnoTabInteraction = function () {  var me = this; //"use strict";
    $("[id^=" + me.pre + "interaction]").show();
    if($("#" + me.pre + "anno_interact").length) $("#" + me.pre + "anno_interact")[0].checked = true;
...
iCn3DUI.prototype.hideAnnoTabInteraction = function () {  var me = this; //"use strict";
    $("[id^=" + me.pre + "interaction]").hide();
    if($("#" + me.pre + "anno_interact").length) $("#" + me.pre + "anno_interact")[0].checked = false;
};

iCn3DUI.prototype.setAnnoTabSsbond = function () {  var me = this; //"use strict";
    $("[id^=" + me.pre + "ssbond]").show();
    if($("#" + me.pre + "anno_ssbond").length) $("#" + me.pre + "anno_ssbond")[0].checked = true;
...
iCn3DUI.prototype.hideAnnoTabTransmem = function () {  var me = this; //"use strict";
    $("[id^=" + me.pre + "transmem]").hide();
    if($("#" + me.pre + "anno_transmem").length) $("#" + me.pre + "anno_transmem")[0].checked = false;
};

iCn3DUI.prototype.setTabs = function () {  var me = this; //"use strict";
...
iCn3DUI.prototype.clickCdd = function() { var me = this; //"use strict";
...
iCn3DUI.prototype.showAnnoSelectedChains = function () {   var me = this; //"use strict";
...
iCn3DUI.prototype.showAnnoAllChains = function () {   var me = this; //"use strict";
    $("#" + me.pre + "dl_annotations > .icn3d-annotation").show();
};

iCn3DUI.prototype.setAnnoView = function(view) { var me = this; //"use strict";
...
iCn3DUI.prototype.showFixedTitle = function() { var me = this; //"use strict";
...
iCn3DUI.prototype.hideFixedTitle = function() { var me = this; //"use strict";
...
iCn3DUI.prototype.setAnnoViewAndDisplay = function(view) { var me = this; //"use strict";
    if(view === 'detailed view') {
