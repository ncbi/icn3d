...
class XyzParser {
    ...
    loadXyzData(data) { var ic = this.icn3d, me = ic.icn3dui;
        var bResult = this.loadXyzAtomData(data);
    ...
    setXyzAtomSeq(AtomHash, moleculeNum, chainNum, residueNum) { var ic = this.icn3d, me = ic.icn3dui;
        ...
        for(var j = 0, jl = serialArray.length; j < jl; ++j) {
            ...
            for(var k = j + 1, kl = serialArray.length; k < kl; ++k) {
                ...
                var maxR = 1.2 *(me.parasCls.covalentRadii[atom0.elem.toUpperCase()] + me.parasCls.covalentRadii[atom1.elem.toUpperCase()]);
    ...
    loadXyzAtomData(data) { var ic = this.icn3d, me = ic.icn3dui;
