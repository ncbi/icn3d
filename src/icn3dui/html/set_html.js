...
iCn3DUI.prototype.setTopMenusHtmlMobile = function (id) { var me = this;
    ...
    html += "  <div id='" + me.pre + "title' class='icn3d-commandTitle' style='font-size:1.2em; font-weight:normal; position:absolute; z-index:1; float:left; display:block; margin: 12px 0px 0px 40px; color:" + me.GREYD + "; width:" + me.WIDTH + "px'></div>";
