...
//$3Dmol.MarchingCubeInitializer = function() { var me = this, ic = me.icn3d; "use strict";
    ...
    // verts, faces - vertex and face arrays to fill up
         ...
         */
        var edgeTableOri = [ 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
...
MarchingCube.prototype.march = function(data, verts, faces, spec) {
    ...
    var etable =(fulltable) ? this.edgeTable2 : this.edgeTable;
    var tritable =(fulltable) ? this.triTable2 : this.triTable;
        ...
        for(var j = 0; j < nY-1; ++j){
            ...
            for(var k = 0; k < nZ-1; ++k){
                ...
                for(var p = 0; p < 8; ++p) {
                    ...
                    var val = !!(data[index] & this.ISDONE);
