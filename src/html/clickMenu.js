...
class ClickMenu {
    ...
    //    clkMn1_mmciffile: function() {
        me.myEventCls.onIds("#" + me.pre + "mn1_mmciffile", "click", function(e) { var ic = me.icn3d;
           me.htmlCls.dialogCls.openDlg('dl_mmciffile', 'Please input mmCIF File');
        });
    //    },
    //    clkMn1_mmcifid: function() {
        me.myEventCls.onIds("#" + me.pre + "mn1_mmcifid", "click", function(e) { var ic = me.icn3d;
           me.htmlCls.dialogCls.openDlg('dl_mmcifid', 'Please input mmCIF ID');
        });
    //    },
    //    clkMn1_mmdbid: function() {
        me.myEventCls.onIds("#" + me.pre + "mn1_mmdbid", "click", function(e) { var ic = me.icn3d;
           me.htmlCls.dialogCls.openDlg('dl_mmdbid', 'Please input MMDB or PDB ID');
        });
    //    },
    //    clkMn1_blast_rep_id: function() {
        me.myEventCls.onIds("#" + me.pre + "mn1_blast_rep_id", "click", function(e) { var ic = me.icn3d;
    ...
    //    clkMn1_pngimage: function() {
        me.myEventCls.onIds("#" + me.pre + "mn1_pngimage", "click", function(e) { var ic = me.icn3d;
           me.htmlCls.dialogCls.openDlg('dl_pngimage', 'Please input the PNG image');
        });
    //    },
    //    clkMn1_state: function() {
        me.myEventCls.onIds("#" + me.pre + "mn1_state", "click", function(e) { var ic = me.icn3d;
           me.htmlCls.dialogCls.openDlg('dl_state', 'Please input the state file');
        });
    //    },
    //    clkMn1_selection: function() {
        me.myEventCls.onIds("#" + me.pre + "mn1_selection", "click", function(e) { var ic = me.icn3d;
           me.htmlCls.dialogCls.openDlg('dl_selection', 'Please input the selection file');
        });
    //    },
    //    clkMn1_dsn6: function() {
        me.myEventCls.onIds("#" + me.pre + "mn1_dsn6", "click", function(e) { var ic = me.icn3d;
           me.htmlCls.dialogCls.openDlg('dl_dsn6', 'Please input the DSN6 file to display electron density map');
        });
    //    },

        me.myEventCls.onIds(["#" + me.pre + "mn1_delphi", "#" + me.pre + "mn1_delphi2"], "click", function(e) { var ic = me.icn3d;
        ...
        me.myEventCls.onIds("#" + me.pre + "mn1_phi", "click", function(e) { var ic = me.icn3d;
           ic.loadPhiFrom = 'phi';
        ...
        me.myEventCls.onIds("#" + me.pre + "mn1_phiurl", "click", function(e) { var ic = me.icn3d;
    ...
    //    clkMn1_dsn6url: function() {
        me.myEventCls.onIds("#" + me.pre + "mn1_dsn6url", "click", function(e) { var ic = me.icn3d;
    ...
    //    clkMn1_exportState: function() {
        me.myEventCls.onIds("#" + me.pre + "mn1_exportState", "click", function(e) { var ic = me.icn3d;
    ...
    //    },
        ...
        me.myEventCls.onIds("#" + me.pre + "mn1_exportPdbRes", "click", function(e) { var ic = me.icn3d;
           me.htmlCls.setHtmlCls.exportPdb();

           thisClass.setLogCmd("export pdb", true);
        });

        me.myEventCls.onIds(["#" + me.pre + "delphipdb", "#" + me.pre + "phipdb"], "click", function(e) { var ic = me.icn3d;
           var pdbStr = ic.saveFileCls.getSelectedResiduePDB();
    ...
    /*
        me.myEventCls.onIds("#" + me.pre + "mn1_exportPdbChain", "click", function(e) { var ic = me.icn3d;
    ...
    */
        me.myEventCls.onIds(["#" + me.pre + "delphipqr", "#" + me.pre + "phipqr", "#" + me.pre + "phiurlpqr"], "click", function(e) { var ic = me.icn3d;
           me.htmlCls.setHtmlCls.exportPqr();
           thisClass.setLogCmd("export pqr", true);
        });

    //    clkMn1_exportStl: function() {
        me.myEventCls.onIds("#" + me.pre + "mn1_exportStl", "click", function(e) { var ic = me.icn3d;
    ...
    //    clkMn1_exportVrml: function() {
        me.myEventCls.onIds("#" + me.pre + "mn1_exportVrml", "click", function(e) { var ic = me.icn3d;
    ...
    //    clkMn1_exportStlStab: function() {
        me.myEventCls.onIds("#" + me.pre + "mn1_exportStlStab", "click", function(e) { var ic = me.icn3d;
    ...
    //    clkMn1_exportVrmlStab: function() {
        me.myEventCls.onIds("#" + me.pre + "mn1_exportVrmlStab", "click", function(e) { var ic = me.icn3d;
    ...
    //    clkMn6_exportInteraction: function() {
        me.myEventCls.onIds("#" + me.pre + "mn6_exportInteraction", "click", function(e) { var ic = me.icn3d;
    ...
    //    clkMn1_exportCanvas: function() {
        me.myEventCls.onIds(["#" + me.pre + "mn1_exportCanvas", "#" + me.pre + "saveimage"], "click", function(e) { var ic = me.icn3d;
        ...
        me.myEventCls.onIds("#" + me.pre + "mn1_exportCanvas2", "click", function(e) { var ic = me.icn3d;
           thisClass.setLogCmd("export canvas 2", false);
           ic.scaleFactor = 2;
           ic.shareLinkCls.shareLink(true);
        });
        me.myEventCls.onIds("#" + me.pre + "mn1_exportCanvas4", "click", function(e) { var ic = me.icn3d;
           thisClass.setLogCmd("export canvas 4", false);
           ic.scaleFactor = 4;
           ic.shareLinkCls.shareLink(true);
        });
        me.myEventCls.onIds("#" + me.pre + "mn1_exportCanvas8", "click", function(e) { var ic = me.icn3d;
    ...
    //    clkMn1_exportCounts: function() {
        me.myEventCls.onIds("#" + me.pre + "mn1_exportCounts", "click", function(e) { var ic = me.icn3d;
    ...
    //    clkMn1_exportSelections: function() {
        me.myEventCls.onIds("#" + me.pre + "mn1_exportSelections", "click", function(e) { var ic = me.icn3d;
          ...
          if(ic.bSetChainsAdvancedMenu === undefined || !ic.bSetChainsAdvancedMenu) {
           ...
           var text = ic.saveFileCls.exportCustomAtoms();
           var file_pref =(ic.inputid) ? ic.inputid : "custom";
           ic.saveFileCls.saveFile(file_pref + '_selections.txt', 'text', [text]);
        });
    //    },
    //    clkMn1_sharelink: function() {
        me.myEventCls.onIds("#" + me.pre + "mn1_sharelink", "click", function(e) { var ic = me.icn3d;
            ic.shareLinkCls.shareLink();
        });
    //    },
    //    clkMn1_replay: function() {
        me.myEventCls.onIds("#" + me.pre + "mn1_replayon", "click", function(e) { var ic = me.icn3d;
          ic.resizeCanvasCls.replayon();
          thisClass.setLogCmd("replay on", true);
        });
        me.myEventCls.onIds("#" + me.pre + "mn1_replayoff", "click", function(e) { var ic = me.icn3d;
            ic.resizeCanvasCls.replayoff();
            thisClass.setLogCmd("replay off", true);
        });
    //    },
    //    clkMn1_link_structure: function() {
        me.myEventCls.onIds("#" + me.pre + "mn1_link_structure", "click", function(e) { var ic = me.icn3d;
           var url = ic.saveFileCls.getLinkToStructureSummary(true);
           window.open(url, '_blank');
        });
    //    },
    //    clkMn1_link_bind: function() {
        me.myEventCls.onIds("#" + me.pre + "mn1_link_bind", "click", function(e) { var ic = me.icn3d;
    ...
    //    clkMn1_link_vast: function() {
        me.myEventCls.onIds("#" + me.pre + "mn1_link_vast", "click", function(e) { var ic = me.icn3d;
    ...
    //    clkMn1_link_pubmed: function() {
        me.myEventCls.onIds("#" + me.pre + "mn1_link_pubmed", "click", function(e) { var ic = me.icn3d;
           var url;
           if(ic.inputid === undefined) {
               var url;
               ...
               var idArray = ic.pmid.toString().split('_');
               var url;
               if(idArray.length === 1) {
               ...
               var idArray = ic.inputid.toString().split('_');
               var url;
               if(idArray.length === 1) {
    ...
    //    clkMn1_link_protein: function() {
        me.myEventCls.onIds("#" + me.pre + "mn1_link_protein", "click", function(e) { var ic = me.icn3d;
          //ic.saveFileCls.setEntrezLinks('protein');
          var structArray = Object.keys(ic.structures);
          var chainArray = Object.keys(ic.chains);
          var text = '';
          for(var i = 0, il = chainArray.length; i < il; ++i) {
              var firstAtom = ic.firstAtomObjCls.getFirstCalphaAtomObj(ic.chains[chainArray[i]]);
    ...
    clickMenu2() { var me = this.icn3dui, ic = me.icn3d;
        if(me.bNode) return;

        var thisClass = this;
    // mn 2
    //    clkMn2_selectannotations: function() {
        me.myEventCls.onIds("#" + me.pre + "mn6_selectannotations", "click", function(e) { var ic = me.icn3d;
    ...
    //    clkMn2_selectall: function() {
        me.myEventCls.onIds("#" + me.pre + "mn2_selectall", "click", function(e) { var ic = me.icn3d;
           thisClass.setLogCmd("select all", true);
           ic.selectionCls.selectAll();
           ic.hlUpdateCls.removeHlAll();
           ic.drawCls.draw();
        });
        me.myEventCls.onIds("#" + me.pre + "clearall", "click", function(e) { var ic = me.icn3d;
    ...
    //    clkMn2_selectdisplayed: function() {
        me.myEventCls.onIds("#" + me.pre + "mn2_selectdisplayed", "click", function(e) { var ic = me.icn3d;
    ...
    //    clkMn2_fullstru: function() {
        me.myEventCls.onIds("#" + me.pre + "mn2_fullstru", "click", function(e) { var ic = me.icn3d;
           thisClass.setLogCmd("show all", true);
           ic.selectionCls.showAll();
        });
    //    },
    //    clkMn2_selectcomplement: function() {
        me.myEventCls.onIds("#" + me.pre + "mn2_selectcomplement", "click", function(e) { var ic = me.icn3d;
    ...
    //    clkMn2_propperty: function() {
        ...
        me.myEventCls.onIds("#" + me.pre + "applypropbybfactor", "click", function(e) { var ic = me.icn3d;
        ...
        me.myEventCls.onIds("#" + me.pre + "applypropbypercentout", "click", function(e) { var ic = me.icn3d;
    ...
    //    clkMn2_alignment: function() {
        me.myEventCls.onIds("#" + me.pre + "mn2_alignment", "click", function(e) { var ic = me.icn3d;
    ...
    //    clkMn2_windows: function() {
        me.myEventCls.onIds("#" + me.pre + "mn1_window_table", "click", function(e) { var ic = me.icn3d;
           me.htmlCls.dialogCls.openDlg('dl_allinteraction', 'Show interactions');
           thisClass.setLogCmd("window interaction table", true);
        });
        me.myEventCls.onIds("#" + me.pre + "mn1_window_linegraph", "click", function(e) { var ic = me.icn3d;
        ...
        me.myEventCls.onIds("#" + me.pre + "mn1_window_scatterplot", "click", function(e) { var ic = me.icn3d;
        ...
        me.myEventCls.onIds("#" + me.pre + "mn1_window_graph", "click", function(e) { var ic = me.icn3d;
    ...
    //    clkMn6_yournote: function() {
        me.myEventCls.onIds("#" + me.pre + "mn6_yournote", "click", function(e) { var ic = me.icn3d;
    ...
    //    clkMn2_command: function() {
        me.myEventCls.onIds("#" + me.pre + "mn2_command", "click", function(e) { var ic = me.icn3d;
           me.htmlCls.dialogCls.openDlg('dl_advanced2', 'Select by specification');
        });
    //    },
    //    clkMn2_definedsets: function() {
        me.myEventCls.onIds(["#" + me.pre + "mn2_definedsets", "#" + me.pre + "definedsets", "#" + me.pre + "definedsets2"], "click", function(e) { var ic = me.icn3d;
           ic.definedSetsCls.showSets();
           thisClass.setLogCmd('defined sets', true);
           //thisClass.setLogCmd('window defined sets', true);
        });
        me.myEventCls.onIds("#" + me.pre + "setOr", "click", function(e) { var ic = me.icn3d;
           ic.setOperation = 'or';
        });
        me.myEventCls.onIds("#" + me.pre + "setAnd", "click", function(e) { var ic = me.icn3d;
           ic.setOperation = 'and';
        });
        me.myEventCls.onIds("#" + me.pre + "setNot", "click", function(e) { var ic = me.icn3d;
           ic.setOperation = 'not';
        });
    //    },
    //    clkMn2_pkNo: function() {
        me.myEventCls.onIds("#" + me.pre + "mn2_pkNo", "click", function(e) { var ic = me.icn3d;
           ic.pk = 0;
           ic.opts['pk'] = 'no';
    ...
    //    clkMn2_pkYes: function() {
        me.myEventCls.onIds("#" + me.pre + "mn2_pkYes", "click", function(e) { var ic = me.icn3d;
           ic.pk = 1;
           ic.opts['pk'] = 'atom';
    ...
    //    clkMn2_pkResidue: function() {
        me.myEventCls.onIds("#" + me.pre + "mn2_pkResidue", "click", function(e) { var ic = me.icn3d;
           ic.pk = 2;
           ic.opts['pk'] = 'residue';
    ...
    //    clkMn2_pkStrand: function() {
        me.myEventCls.onIds("#" + me.pre + "mn2_pkStrand", "click", function(e) { var ic = me.icn3d;
           ic.pk = 3;
           ic.opts['pk'] = 'strand';
    ...
    //    clkMn2_pkDomain: function() {
        me.myEventCls.onIds("#" + me.pre + "mn2_pkDomain", "click", function(e) { var ic = me.icn3d;
           ic.pk = 4;
           ic.opts['pk'] = 'domain';
    ...
    //    clkMn2_pkChain: function() {
        me.myEventCls.onIds("#" + me.pre + "mn2_pkChain", "click", function(e) { var ic = me.icn3d;
           ic.pk = 5;
           ic.opts['pk'] = 'chain';
    ...
    //    clkMn2_select_chain: function() {
        me.myEventCls.onIds(["#" + me.pre + "mn2_select_chain", "#" + me.pre + "definedSets"], "click", function(e) { var ic = me.icn3d;
           me.htmlCls.dialogCls.openDlg('dl_select_chain', 'Select Structure/Chain/Custom Selection');
        });
    //    },
    }

    clickMenu3() { var me = this.icn3dui, ic = me.icn3d;
        if(me.bNode) return;

        var thisClass = this;
    // mn 3
    //    clkMn3_proteinsRibbon: function() {
        me.myEventCls.onIds("#" + me.pre + "mn3_proteinsRibbon", "click", function(e) { var ic = me.icn3d;
           ic.setOptionCls.setStyle('proteins', 'ribbon');
           thisClass.setLogCmd('style proteins ribbon', true);
        });
    //    },
    //    clkMn3_proteinsStrand: function() {
        me.myEventCls.onIds("#" + me.pre + "mn3_proteinsStrand", "click", function(e) { var ic = me.icn3d;
           ic.setOptionCls.setStyle('proteins', 'strand');
           thisClass.setLogCmd('style proteins strand', true);
        });
    //    },
    //    clkMn3_proteinsCylinder: function() {
        me.myEventCls.onIds("#" + me.pre + "mn3_proteinsCylinder", "click", function(e) { var ic = me.icn3d;
    ...
    //    clkMn3_proteinsSchematic: function() {
        me.myEventCls.onIds("#" + me.pre + "mn3_proteinsSchematic", "click", function(e) { var ic = me.icn3d;
    ...
    //    clkMn3_proteinsCalpha: function() {
        me.myEventCls.onIds("#" + me.pre + "mn3_proteinsCalpha", "click", function(e) { var ic = me.icn3d;
    ...
    //    clkMn3_proteinsBackbone: function() {
        me.myEventCls.onIds("#" + me.pre + "mn3_proteinsBackbone", "click", function(e) { var ic = me.icn3d;
    ...
    //    clkMn3_proteinsBfactor: function() {
        me.myEventCls.onIds("#" + me.pre + "mn3_proteinsBfactor", "click", function(e) { var ic = me.icn3d;
    ...
    //    clkMn3_proteinsLines: function() {
        me.myEventCls.onIds("#" + me.pre + "mn3_proteinsLines", "click", function(e) { var ic = me.icn3d;
           ic.setOptionCls.setStyle('proteins', 'lines');
           thisClass.setLogCmd('style proteins lines', true);
        });
    //    },
    //    clkMn3_proteinsStick: function() {
        me.myEventCls.onIds("#" + me.pre + "mn3_proteinsStick", "click", function(e) { var ic = me.icn3d;
           ic.setOptionCls.setStyle('proteins', 'stick');
           thisClass.setLogCmd('style proteins stick', true);
        });
    //    },
    //    clkMn3_proteinsBallstick: function() {
        me.myEventCls.onIds("#" + me.pre + "mn3_proteinsBallstick", "click", function(e) { var ic = me.icn3d;
    ...
    //    clkMn3_sidecSphere: function() {
        me.myEventCls.onIds("#" + me.pre + "mn3_sidecSphere", "click", function(e) { var ic = me.icn3d;
           ic.setOptionCls.setStyle('sidec', 'sphere');
           thisClass.setLogCmd('style sidec sphere', true);
        });
    //    },
    //    clkMn3_sidecNo: function() {
        me.myEventCls.onIds("#" + me.pre + "mn3_sidecNo", "click", function(e) { var ic = me.icn3d;
           ic.setOptionCls.setStyle('sidec', 'nothing');
           thisClass.setLogCmd('style sidec nothing', true);
        });
    //    },
    //    clkMn3_nuclCartoon: function() {
        me.myEventCls.onIds("#" + me.pre + "mn3_nuclCartoon", "click", function(e) { var ic = me.icn3d;
    ...
    //    clkMn3_nuclBackbone: function() {
        me.myEventCls.onIds("#" + me.pre + "mn3_nuclBackbone", "click", function(e) { var ic = me.icn3d;
    ...
    //    clkMn3_nuclSchematic: function() {
        me.myEventCls.onIds("#" + me.pre + "mn3_nuclSchematic", "click", function(e) { var ic = me.icn3d;
    ...
    //    clkMn3_nuclPhos: function() {
        me.myEventCls.onIds("#" + me.pre + "mn3_nuclPhos", "click", function(e) { var ic = me.icn3d;
    ...
    //    clkMn3_hydrogensYes: function() {
        me.myEventCls.onIds("#" + me.pre + "mn3_hydrogensYes", "click", function(e) { var ic = me.icn3d;
    ...
    //    clkMn3_hydrogensNo: function() {
        me.myEventCls.onIds("#" + me.pre + "mn3_hydrogensNo", "click", function(e) { var ic = me.icn3d;
    ...
    clickMenu4() { var me = this.icn3dui, ic = me.icn3d;
        if(me.bNode) return;

        var thisClass = this;
    // mn 4
    //    clkMn4_clrSpectrum: function() {
        me.myEventCls.onIds("#" + me.pre + "mn4_clrSpectrum", "click", function(e) { var ic = me.icn3d;
           ic.setOptionCls.setOption('color', 'spectrum');
           thisClass.setLogCmd('color spectrum', true);
        });
    //    },
    //    clkMn4_clrChain: function() {
        me.myEventCls.onIds("#" + me.pre + "mn4_clrChain", "click", function(e) { var ic = me.icn3d;
           ic.setOptionCls.setOption('color', 'chain');
           thisClass.setLogCmd('color chain', true);
        });
    //    },
    //    clkMn4_clrDomain: function() {
        me.myEventCls.onIds("#" + me.pre + "mn4_clrdomain", "click", function(e) { var ic = me.icn3d;
           ic.setOptionCls.setOption('color', 'domain');
           thisClass.setLogCmd('color domain', true);
        });
    //    },
    //    clkMn4_clrSSGreen: function() {
        me.myEventCls.onIds("#" + me.pre + "mn4_clrSSGreen", "click", function(e) { var ic = me.icn3d;
           ic.sheetcolor = 'green';
    ...
    //    clkMn4_clrSSYellow: function() {
        me.myEventCls.onIds("#" + me.pre + "mn4_clrSSYellow", "click", function(e) { var ic = me.icn3d;
    ...
    //    clkMn4_clrSSSpectrum: function() {
        me.myEventCls.onIds("#" + me.pre + "mn4_clrSSSpectrum", "click", function(e) { var ic = me.icn3d;
    ...
    //    clkMn4_clrResidue: function() {
        me.myEventCls.onIds("#" + me.pre + "mn4_clrResidue", "click", function(e) { var ic = me.icn3d;
           ic.setOptionCls.setOption('color', 'residue');
           thisClass.setLogCmd('color residue', true);
        });
    //    },
    //    clkMn4_clrResidueCustom: function() {
        me.myEventCls.onIds("#" + me.pre + "mn4_clrResidueCustom", "click", function(e) { var ic = me.icn3d;
           me.htmlCls.dialogCls.openDlg('dl_rescolorfile', 'Please input the file on residue colors');
        });
    //    },
    //    clkMn4_reloadRescolorfile: function() {
        me.myEventCls.onIds("#" + me.pre + "reload_rescolorfile", "click", function(e) { var ic = me.icn3d;
           e.preventDefault();
           if(!me.cfg.notebook) dialog.dialog( "close" );
    ...
    //    clkMn4_clrBfactorNorm: function() {
        me.myEventCls.onIds("#" + me.pre + "mn4_clrBfactorNorm", "click", function(e) { var ic = me.icn3d;
    ...
    //    clkMn4_clrIdentity: function() {
        me.myEventCls.onIds("#" + me.pre + "mn4_clrIdentity", "click", function(e) { var ic = me.icn3d;
           ic.setOptionCls.setOption('color', 'identity');
           thisClass.setLogCmd('color identity', true);
        });
    //    },
    //    clkMn4_clrConserved: function() {
        me.myEventCls.onIds("#" + me.pre + "mn4_clrConserved", "click", function(e) { var ic = me.icn3d;
           ic.setOptionCls.setOption('color', 'conservation');
           thisClass.setLogCmd('color conservation', true);
        });
    //    },
    //    clkMn4_clrCustom: function() {
        me.myEventCls.onIds("#" + me.pre + "mn4_clrCustom", "click", function(e) { var ic = me.icn3d;
    ...
    //    clkMn4_clrSave: function() {
        me.myEventCls.onIds("#" + me.pre + "mn4_clrSave", "click", function(e) { var ic = me.icn3d;
           ic.setOptionCls.saveColor();
           thisClass.setLogCmd('save color', true);
        });
    //    },
    //    clkMn4_clrApplySave: function() {
        me.myEventCls.onIds("#" + me.pre + "mn4_clrApplySave", "click", function(e) { var ic = me.icn3d;
           ic.setOptionCls.applySavedColor();
           thisClass.setLogCmd('apply saved color', true);
        });
    //    },
    //    clkMn3_styleSave: function() {
        me.myEventCls.onIds("#" + me.pre + "mn3_styleSave", "click", function(e) { var ic = me.icn3d;
           ic.setOptionCls.saveStyle();
           thisClass.setLogCmd('save style', true);
        });
    //    },
    //    clkMn3_styleApplySave: function() {
        me.myEventCls.onIds("#" + me.pre + "mn3_styleApplySave", "click", function(e) { var ic = me.icn3d;
    ...
    clickMenu5() { var me = this.icn3dui, ic = me.icn3d;
        if(me.bNode) return;

        var thisClass = this;
    // mn 5
    //    clkMn5_neighborsYes: function() {
        me.myEventCls.onIds("#" + me.pre + "mn5_neighborsYes", "click", function(e) { var ic = me.icn3d;
    ...
    //    clkMn5_neighborsNo: function() {
        me.myEventCls.onIds("#" + me.pre + "mn5_neighborsNo", "click", function(e) { var ic = me.icn3d;
    ...
    //    clkMn5_surfaceVDW: function() {
        me.myEventCls.onIds("#" + me.pre + "mn5_surfaceVDW", "click", function(e) { var ic = me.icn3d;
           ic.bConsiderNeighbors = false;
    ...
    //    clkMn5_surfaceSAS: function() {
        me.myEventCls.onIds("#" + me.pre + "mn5_surfaceSAS", "click", function(e) { var ic = me.icn3d;
           ic.bConsiderNeighbors = false;
    ...
    //    clkMn5_surfaceMolecular: function() {
        me.myEventCls.onIds("#" + me.pre + "mn5_surfaceMolecular", "click", function(e) { var ic = me.icn3d;
           ic.bConsiderNeighbors = false;
    ...
    //    clkMn5_surfaceVDWContext: function() {
        me.myEventCls.onIds("#" + me.pre + "mn5_surfaceVDWContext", "click", function(e) { var ic = me.icn3d;
           ic.bConsiderNeighbors = true;
    ...
    //    clkMn5_surfaceSASContext: function() {
        me.myEventCls.onIds("#" + me.pre + "mn5_surfaceSASContext", "click", function(e) { var ic = me.icn3d;
           ic.bConsiderNeighbors = true;
    ...
    //    clkMn5_surfaceMolecularContext: function() {
        me.myEventCls.onIds("#" + me.pre + "mn5_surfaceMolecularContext", "click", function(e) { var ic = me.icn3d;
           ic.bConsiderNeighbors = true;
    ...
    //    clkMn5_surfaceNo: function() {
        me.myEventCls.onIds("#" + me.pre + "mn5_surfaceNo", "click", function(e) { var ic = me.icn3d;
    ...
    */
        ...
        $(document).on("click", "." + me.pre + "mn5_opacity", function(e) { var ic = me.icn3d;
           var value = $(this).attr('v');
           ic.setOptionCls.setOption('opacity', value);
           thisClass.setLogCmd('set surface opacity ' + value, true);
        });
    ...
    //    clkMn5_wireframeYes: function() {
        me.myEventCls.onIds("#" + me.pre + "mn5_wireframeYes", "click", function(e) { var ic = me.icn3d;
           ic.setOptionCls.setOption('wireframe', 'yes');
           thisClass.setLogCmd('set surface wireframe on', true);
        });
    //    },
    //    clkMn5_wireframeNo: function() {
        me.myEventCls.onIds("#" + me.pre + "mn5_wireframeNo", "click", function(e) { var ic = me.icn3d;
           ic.setOptionCls.setOption('wireframe', 'no');
           thisClass.setLogCmd('set surface wireframe off', true);
        });
    //    },
    //    clkMn5_elecmap2fofc: function() {
        me.myEventCls.onIds("#" + me.pre + "mn5_elecmap2fofc", "click", function(e) { var ic = me.icn3d;
           me.htmlCls.dialogCls.openDlg('dl_elecmap2fofc', '2Fo-Fc Electron Density Map');
        });
    //    },
    //    clkMn5_elecmapfofc: function() {
        me.myEventCls.onIds("#" + me.pre + "mn5_elecmapfofc", "click", function(e) { var ic = me.icn3d;
           me.htmlCls.dialogCls.openDlg('dl_elecmapfofc', 'Fo-Fc Electron Density Map');
        });
    //    },
    //    clkMn5_elecmapNo: function() {
        me.myEventCls.onIds(["#" + me.pre + "mn5_elecmapNo", "#" + me.pre + "elecmapNo2", "#" + me.pre + "elecmapNo3", "#" + me.pre + "elecmapNo4", "#" + me.pre + "elecmapNo5"], "click", function(e) { var ic = me.icn3d;
           ic.setOptionCls.setOption('map', 'nothing');
           thisClass.setLogCmd('setoption map nothing', true);
        });
    //    },
        me.myEventCls.onIds(["#" + me.pre + "delphimapNo", "#" + me.pre + "phimapNo", "#" + me.pre + "phiurlmapNo", "#" + me.pre + "mn1_phimapNo"], "click", function(e) { var ic = me.icn3d;
           ic.setOptionCls.setOption('phimap', 'nothing');
           thisClass.setLogCmd('setoption phimap nothing', true);
        });

        me.myEventCls.onIds(["#" + me.pre + "delphimapNo2", "#" + me.pre + "phimapNo2", "#" + me.pre + "phiurlmapNo2"], "click", function(e) { var ic = me.icn3d;
           //ic.setOptionCls.setOption('surface', 'nothing');
           //thisClass.setLogCmd('set surface nothing', true);
    ...
    //    clickApplymap2fofc: function() {
        me.myEventCls.onIds("#" + me.pre + "applymap2fofc", "click", function(e) { var ic = me.icn3d;
           e.preventDefault();
           //if(!me.cfg.notebook) dialog.dialog( "close" );
    ...
    //    clickApplymapfofc: function() {
        me.myEventCls.onIds("#" + me.pre + "applymapfofc", "click", function(e) { var ic = me.icn3d;
           e.preventDefault();
           //if(!me.cfg.notebook) dialog.dialog( "close" );
    ...
    //    clkMn5_mapwireframeYes: function() {
        me.myEventCls.onIds("#" + me.pre + "mn5_mapwireframeYes", "click", function(e) { var ic = me.icn3d;
    ...
    //    clkMn5_mapwireframeNo: function() {
        me.myEventCls.onIds("#" + me.pre + "mn5_mapwireframeNo", "click", function(e) { var ic = me.icn3d;
           ic.setOptionCls.setOption('mapwireframe', 'no');
           thisClass.setLogCmd('set map wireframe off', true);
        });
    //    },
    //    clkMn5_emmap: function() {
        me.myEventCls.onIds("#" + me.pre + "mn5_emmap", "click", function(e) { var ic = me.icn3d;
           me.htmlCls.dialogCls.openDlg('dl_emmap', 'EM Density Map');
        });
    //    },
    //    clkMn5_emmapNo: function() {
        me.myEventCls.onIds(["#" + me.pre + "mn5_emmapNo", "#" + me.pre + "emmapNo2"], "click", function(e) { var ic = me.icn3d;
           ic.setOptionCls.setOption('emmap', 'nothing');
           thisClass.setLogCmd('setoption emmap nothing', true);
        });
    //    },
    //    clickApplyemmap: function() {
        me.myEventCls.onIds("#" + me.pre + "applyemmap", "click", function(e) { var ic = me.icn3d;
           e.preventDefault();
           //if(!me.cfg.notebook) dialog.dialog( "close" );
    ...
    //    clkMn5_emmapwireframeYes: function() {
        me.myEventCls.onIds("#" + me.pre + "mn5_emmapwireframeYes", "click", function(e) { var ic = me.icn3d;
           //ic.dsn6ParserCls.dsn6Parser(ic.inputid);
    ...
    //    clkMn5_emmapwireframeNo: function() {
        me.myEventCls.onIds("#" + me.pre + "mn5_emmapwireframeNo", "click", function(e) { var ic = me.icn3d;
    ...
    clickMenu6() { var me = this.icn3dui, ic = me.icn3d;
        if(me.bNode) return;

        var thisClass = this;
    // mn 6
    //    clkMn6_assemblyYes: function() {
        me.myEventCls.onIds("#" + me.pre + "mn6_assemblyYes", "click", function(e) { var ic = me.icn3d;
           ic.bAssembly = true;
    ...
    //    clkMn6_assemblyNo: function() {
        me.myEventCls.onIds("#" + me.pre + "mn6_assemblyNo", "click", function(e) { var ic = me.icn3d;
           ic.bAssembly = false;
    ...
    //    clkMn6_addlabelAtoms: function() {
        me.myEventCls.onIds("#" + me.pre + "mn6_addlabelAtoms", "click", function(e) { var ic = me.icn3d;
    ...
    //    clkMn6_addlabelResidues: function() {
        me.myEventCls.onIds("#" + me.pre + "mn6_addlabelResidues", "click", function(e) { var ic = me.icn3d;
    ...
    //    clkMn6_addlabelResnum: function() {
        me.myEventCls.onIds("#" + me.pre + "mn6_addlabelResnum", "click", function(e) { var ic = me.icn3d;
    ...
    //    clkMn6_addlabelChains: function() {
        me.myEventCls.onIds("#" + me.pre + "mn6_addlabelChains", "click", function(e) { var ic = me.icn3d;
    ...
    //    clkMn6_addlabelTermini: function() {
        me.myEventCls.onIds("#" + me.pre + "mn6_addlabelTermini", "click", function(e) { var ic = me.icn3d;
    ...
    //    clkMn6_addlabelYes: function() {
        me.myEventCls.onIds("#" + me.pre + "mn6_addlabelYes", "click", function(e) { var ic = me.icn3d;
    ...
    //    clkMn6_addlabelSelection: function() {
        me.myEventCls.onIds("#" + me.pre + "mn6_addlabelSelection", "click", function(e) { var ic = me.icn3d;
           me.htmlCls.dialogCls.openDlg('dl_addlabelselection', 'Add custom labels by the selected');
        });
    //    },
    //    clkMn2_saveselection: function() {
        me.myEventCls.onIds("#" + me.pre + "mn2_saveselection", "click", function(e) { var ic = me.icn3d;
           me.htmlCls.dialogCls.openDlg('dl_saveselection', 'Save the selected');
        });
    //    },
    //    clkMn6_addlabelNo: function() {
        me.myEventCls.onIds(["#" + me.pre + "mn6_addlabelNo", "#" + me.pre + "removeLabels"], "click", function(e) { var ic = me.icn3d;
           ic.pickpair = false;
           //ic.labels['residue'] = [];
           //ic.labels['custom'] = [];
    ...
    */
        $(document).on("click", "." + me.pre + "mn6_labelscale", function(e) { var ic = me.icn3d;
           var value = $(this).attr('v');
           ic.labelScale = value;
           ic.drawCls.draw();
           thisClass.setLogCmd('set label scale ' + value, true);
    ...
    //    clkMn6_distanceYes: function() {
        me.myEventCls.onIds("#" + me.pre + "mn6_distanceYes", "click", function(e) { var ic = me.icn3d;
    ...
    //    },
        ...
        me.myEventCls.onIds("#" + me.pre + "mn6_distTwoSets", "click", function(e) { var ic = me.icn3d;
    ...
    //    clkMn6_distanceNo: function() {
        me.myEventCls.onIds("#" + me.pre + "mn6_distanceNo", "click", function(e) { var ic = me.icn3d;
           ic.pickpair = false;
    ...
    //    clkMn2_selectedcenter: function() {
        me.myEventCls.onIds(["#" + me.pre + "mn2_selectedcenter", "#" + me.pre + "zoomin_selection"], "click", function(e) { var ic = me.icn3d;
    ...
    //    clkMn6_center: function() {
        me.myEventCls.onIds("#" + me.pre + "mn6_center", "click", function(e) { var ic = me.icn3d;
    ...
    //    clkMn6_resetOrientation: function() {
        me.myEventCls.onIds(["#" + me.pre + "mn6_resetOrientation", "#" + me.pre + "resetOrientation"], "click", function(e) { var ic = me.icn3d;
    ...
    //    clkMn6_chemicalbindingshow: function() {
        me.myEventCls.onIds(["#" + me.pre + "mn6_chemicalbindingshow", "#" + me.pre + "chemicalbindingshow"], "click", function(e) { var ic = me.icn3d;
    ...
    //    clkMn6_chemicalbindinghide: function() {
        me.myEventCls.onIds(["#" + me.pre + "mn6_chemicalbindinghide", "#" + me.pre + "chemicalbindinghide"], "click", function(e) { var ic = me.icn3d;
    ...
    //    clkMn6_sidebyside: function() {
        me.myEventCls.onIds("#" + me.pre + "mn6_sidebyside", "click", function(e) { var ic = me.icn3d;
           var bSidebyside = true;
           var url = ic.shareLinkCls.shareLinkUrl(undefined);
    ...
    */
        ...
        $(document).on("click", "." + me.pre + "mn6_rotate", function(e) { var ic = me.icn3d;
           var value = $(this).attr('v').toLowerCase();
           var direction = value.split(' ')[1];
        ...
        $(document).on("click", "." + me.pre + "mn6_rotate90", function(e) { var ic = me.icn3d;
          var value = $(this).attr('v').toLowerCase();
          var direction = value.split('-')[0];
    ...
    //    clkMn6_cameraPers: function() {
        me.myEventCls.onIds("#" + me.pre + "mn6_cameraPers", "click", function(e) { var ic = me.icn3d;
           ic.setOptionCls.setOption('camera', 'perspective');
           thisClass.setLogCmd('set camera perspective', true);
        });
    //    },
    //    clkMn6_cameraOrth: function() {
        me.myEventCls.onIds("#" + me.pre + "mn6_cameraOrth", "click", function(e) { var ic = me.icn3d;
           ic.setOptionCls.setOption('camera', 'orthographic');
           thisClass.setLogCmd('set camera orthographic', true);
        });
    //    },
    //    clkMn6_bkgdBlack: function() {
        me.myEventCls.onIds("#" + me.pre + "mn6_bkgdBlack", "click", function(e) { var ic = me.icn3d;
           ic.setStyleCls.setBackground('black');
        });
    //    },
    //    clkMn6_bkgdGrey: function() {
        me.myEventCls.onIds("#" + me.pre + "mn6_bkgdGrey", "click", function(e) { var ic = me.icn3d;
           ic.setStyleCls.setBackground('grey');
        });
    //    },
    //    clkMn6_bkgdWhite: function() {
        me.myEventCls.onIds("#" + me.pre + "mn6_bkgdWhite", "click", function(e) { var ic = me.icn3d;
           ic.setStyleCls.setBackground('white');
        });
    //    },
    //    clkMn6_bkgdTransparent: function() {
        me.myEventCls.onIds("#" + me.pre + "mn6_bkgdTransparent", "click", function(e) { var ic = me.icn3d;
           ic.setStyleCls.setBackground('transparent');
        });
    //    },
    //    clkMn6_showfogYes: function() {
        me.myEventCls.onIds("#" + me.pre + "mn6_showfogYes", "click", function(e) { var ic = me.icn3d;
    ...
    //    clkMn6_showfogNo: function() {
        me.myEventCls.onIds("#" + me.pre + "mn6_showfogNo", "click", function(e) { var ic = me.icn3d;
    ...
    //    clkMn6_showslabYes: function() {
        me.myEventCls.onIds("#" + me.pre + "mn6_showslabYes", "click", function(e) { var ic = me.icn3d;
           ic.setOptionCls.setOption('slab', 'yes');
           thisClass.setLogCmd('set slab on', true);
        });
    //    },
    //    clkMn6_showslabNo: function() {
        me.myEventCls.onIds("#" + me.pre + "mn6_showslabNo", "click", function(e) { var ic = me.icn3d;
           ic.setOptionCls.setOption('slab', 'no');
           thisClass.setLogCmd('set slab off', true);
        });
    //    },
    //    clkMn6_showaxisYes: function() {
        me.myEventCls.onIds("#" + me.pre + "mn6_showaxisYes", "click", function(e) { var ic = me.icn3d;
           ic.setOptionCls.setOption('axis', 'yes');
           thisClass.setLogCmd('set axis on', true);
        });

        me.myEventCls.onIds("#" + me.pre + "mn6_showaxisSel", "click", function(e) { var ic = me.icn3d;
           ic.pc1 = true;
    ...
    //    clkMn6_showaxisNo: function() {
        me.myEventCls.onIds("#" + me.pre + "mn6_showaxisNo", "click", function(e) { var ic = me.icn3d;
           ic.pc1 = false;
           ic.axes = [];
    ...
    //    clkMn6_symmetry: function() {
        ...
        me.myEventCls.onIds("#" + me.pre + "mn6_clear_sym", "click", function(e) { var ic = me.icn3d;
           ic.symdArray = [];
           ic.drawCls.draw();
    ...
    //    clkMn6_area: function() {
        me.myEventCls.onIds("#" + me.pre + "mn6_area", "click", function(e) { var ic = me.icn3d;
    ...
    //    clkMn6_applysymmetry: function() {
        ...
        me.myEventCls.onIds("#" + me.pre + "clearsymmetry", "click", function(e) { var ic = me.icn3d;
           var title = 'none';
    ...
    /*
        me.myEventCls.onIds("#" + me.pre + "applysymd", "click", function(e) { var ic = me.icn3d;
           var title = $("#" + me.pre + "selectSymd" ).val();
           ic.symdtitle =(title === 'none') ? undefined : title;
           ic.drawCls.draw();
           thisClass.setLogCmd('symd symmetry ' + title, true);
        });
        me.myEventCls.onIds("#" + me.pre + "clearsymd", "click", function(e) { var ic = me.icn3d;
           var title = 'none';
    ...
    */
    ...
    //    clkMn6_hbondsYes: function() {
        me.myEventCls.onIds(["#" + me.pre + "mn6_hbondsYes", "#" + me.pre + "hbondsYes"], "click", function(e) { var ic = me.icn3d;
            if(ic.bSetChainsAdvancedMenu === undefined || !ic.bSetChainsAdvancedMenu) {
               var prevHAtoms = me.hashUtilsCls.cloneHash(ic.hAtoms);
               ic.definedSetsCls.setPredefinedInMenu();
               ic.bSetChainsAdvancedMenu = true;
    ...
    //    clkmn1_stabilizerYes: function() {
        me.myEventCls.onIds("#" + me.pre + "mn1_stabilizerYes", "click", function(e) { var ic = me.icn3d;
    ...
    //    clkmn1_stabilizerNo: function() {
        me.myEventCls.onIds("#" + me.pre + "mn1_stabilizerNo", "click", function(e) { var ic = me.icn3d;
    ...
    //    clkmn1_stabilizerOne: function() {
        me.myEventCls.onIds("#" + me.pre + "mn1_stabilizerOne", "click", function(e) { var ic = me.icn3d;
    ...
    //    clkmn1_stabilizerRmOne: function() {
        me.myEventCls.onIds("#" + me.pre + "mn1_stabilizerRmOne", "click", function(e) { var ic = me.icn3d;
    ...
    //    clkmn1_thicknessSet: function() {
        me.myEventCls.onIds("#" + me.pre + "mn1_thicknessSet", "click", function(e) { var ic = me.icn3d;
    ...
    //    clkMn6_ssbondsExport: function() {
        me.myEventCls.onIds("#" + me.pre + "mn6_ssbondsExport", "click", function(e) { var ic = me.icn3d;
           ic.viewInterPairsCls.exportSsbondPairs();
           thisClass.setLogCmd("export disulfide bond pairs", false);
        });
    //    },
    //    clkMn6_ssbondsNo: function() {
        me.myEventCls.onIds("#" + me.pre + "mn6_ssbondsNo", "click", function(e) { var ic = me.icn3d;
           ic.opts["ssbonds"] = "no";
    ...
    //    clkMn6_clbondsYes: function() {
        me.myEventCls.onIds("#" + me.pre + "mn6_clbondsYes", "click", function(e) { var ic = me.icn3d;
    ...
    //    clkMn6_clbondsExport: function() {
        me.myEventCls.onIds("#" + me.pre + "mn6_clbondsExport", "click", function(e) { var ic = me.icn3d;
           ic.viewInterPairsCls.exportClbondPairs();
           thisClass.setLogCmd("export cross linkage pairs", false);
        });
    //    },
    //    clkMn6_clbondsNo: function() {
        me.myEventCls.onIds("#" + me.pre + "mn6_clbondsNo", "click", function(e) { var ic = me.icn3d;
           ic.opts["clbonds"] = "no";
      ...
      if(bSetCommand) {
          ...
          if(ic.bAddCommands) {
              ...
              if(ic.STATENUMBER < ic.commands.length) {
                  var oldCommand = ic.commands[ic.STATENUMBER - 1];
