...
* <b>Save your work</b>: 
    ...
    The "iCn3D PNG Image" can also be stored in a web server with access control (CORS) set as allowing any origin. The PNG image can then be loaded into iCn3D via the URL, e.g., [https://structure.ncbi.nlm.nih.gov/icn3d/?type=icn3dpng&url=https://icn3d.org/png/20230119_06_3GVU-XCxR6fSTmXHxR3o1A.png](https://structure.ncbi.nlm.nih.gov/icn3d/?type=icn3dpng&url=https://icn3d.org/png/20230119_06_3GVU-XCxR6fSTmXHxR3o1A.png). If you own a web server, you can add the file ".htaccess" with the following content:
    ```
