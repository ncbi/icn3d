...
class SetDialog {
  ...
  setDialogs() {
    ...
    html +=
      "<b>Note</b>: Always load a PDB file before loading map files. <br/><br/><br/>";

    html +=
      "<span style='white-space:nowrap;font-weight:bold;'>2fofc contour at: <select id='" +
      me.pre +
      "dsn6sigma2fofc'>";
    ...
    html +=
      ...
      "dsn6file2fofc'> " +
      me.htmlCls.buttonStr +
      "reload_dsn6file2fofc' style='margin: 6px 20px 0 0;'>Load DSN6</button><br><br><br/>";
    ...
    html +=
      "<span style='white-space:nowrap;font-weight:bold;'>fofc contour at: <select id='" +
      me.pre +
      "dsn6sigmafofc'>";
    ...
    html +=
      ...
      "dsn6filefofc'> " +
      me.htmlCls.buttonStr +
      "reload_dsn6filefofc' style='margin: 6px 20px 0 0;'>Load DSN6</button><br><br><br>";
    ...
    html +=
      ...
      me.htmlCls.space3 +
      me.htmlCls.buttonStr +
      "reload_dsn6fileurl2fofc' style='margin-top: 6px;'>Load</button><br><br><br/>";
    ...
    html +=
      ...
      me.htmlCls.space3 +
      me.htmlCls.buttonStr +
      "reload_dsn6fileurlfofc' style='margin-top: 6px;'>Load</button><br><br><br/>";
